...
if ( !class_exists( 'Newsletter_Card' ) ) {
    class Newsletter_Card {
        ...
        /**
         * Main Newsletter Card Instance.
         *
         * Ensures only one instance of Newsletter Card Instance is loaded or can be loaded.
         *
         * @param $plugin_name
         * @param $plugin_slug
         *
         ...
         *
         * - Newsletter_Card_Loader. Orchestrates the hooks of the plugin.
         * - Newsletter_Card_Admin_Page. Defines all hooks for the admin area.
         * - Newsletter_Card_Public. Defines all hooks for the public side of the site.
         *
